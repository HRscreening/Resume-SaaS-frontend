          ...
          <table className="w-full candidates-table">
            <thead>
              <tr className="border-b border-[#E8E5DF]">
                ...
                <th className="px-6 py-3.5 text-left text-xs font-medium text-[#737373] uppercase tracking-wide hidden md:table-cell">Applications</th>
                <th className="px-6 py-3.5 text-left text-xs font-medium text-[#737373] uppercase tracking-wide hidden md:table-cell">Screened</th>
                ...
                <th className="px-6 py-3.5 text-left text-xs font-medium text-[#737373] uppercase tracking-wide hidden lg:table-cell">last Accessed</th>
