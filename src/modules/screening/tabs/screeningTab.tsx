...
export default function ScreeningDetail({ setCurrentTab, setSourceMode }: ScreeningDetailProps) {
    ...
    if (candidates.length === 0 && !pageLoading && !hasActiveFilters(queryState) && screening.scored_resumes__cnt === 0 && !active_batches?.scoring_batch_ids?.length) {
        return (
            <div className="p-4 sm:p-6 md:p-8 text-center">
                <p className="text-sm text-[#737373]">
    ...
    const totalCandidates = screening.scored_resumes__cnt ?? 0;
